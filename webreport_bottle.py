...
def Webreport():
    ...
    ## return str(get_data())
    return template('webreport', get_data(timestr))
...
def first_page():
    ...
    """
    return template('webreport', get_data('first'))
...
def previous_page():
    ...
    """
    return template('webreport', get_data('prev'))
...
def next_page():
    ...
    """
    return template('webreport', get_data('next'))
...
def last_page():
    ...
    """
    return template('webreport', get_data('last'))
