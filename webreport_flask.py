...
def Webreport():
    ...
    return render_template('webreport.html', **data)
...
def first_page():
    ...
    """
    return render_template('webreport.html', **get_data('first'))
...
def previous_page():
    ...
    """
    return render_template('webreport.html', **get_data('prev'))
...
def next_page():
    ...
    """
    return render_template('webreport.html', **get_data('next'))
...
def last_page():
    ...
    """
    return render_template('webreport.html', **get_data('last'))
